...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (that == null) throw new NullPointerException("Invalid argument");
        if (that.y == this.y && that.x == this.x) return Double.NEGATIVE_INFINITY;
        else if (that.y == this.y) return +0.00; // horiztonal line
    ...
    public static void main(String[] args) {
        Point p = new Point(48, 187);
        Point q = new Point(283, 371);
        Point r = new Point(313, 194);
